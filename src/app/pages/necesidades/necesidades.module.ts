...
import { NoteNecesidadesComponent } from './notes-necesidades/notes-necesidades.component';
...
import { EntenderNecesidadesAccordionComponent } from './instructions/entender-necesidades-accordion/entender-necesidades-accordion.component';
...
@NgModule({
  declarations: [
    ...
    NoteNecesidadesComponent,
    //TimerComponent,
    EntenderNecesidadesAccordionComponent
  ],
  imports: [
    CommonModule,
