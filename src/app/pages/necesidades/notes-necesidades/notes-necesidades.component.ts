...
@Component({
  selector:'app-note-necesidades',
  templateUrl:'./notes-necesidades.component.html',
  styleUrls:['./notes-necesidades.component.css']
})

export class NoteNecesidadesComponent {
