...
import { NoteMapaCalorComponent } from './notes-mapa-calor/notes-mapa-calor.component';
...
import { EntenderMapaCalorAccordionComponent } from './instructions/entender-mapa-calor-accordion/entender-mapa-calor-accordion.component';
...
@NgModule({
  declarations: [
    MapaCalorComponent,
    NoteMapaCalorComponent,
    //TimerComponent,
    EntenderMapaCalorAccordionComponent
  ],
  imports: [
    CommonModule,
