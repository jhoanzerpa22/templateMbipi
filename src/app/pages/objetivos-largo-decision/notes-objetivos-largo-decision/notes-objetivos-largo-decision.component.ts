...
@Component({
  selector:'app-note-objetivos-largo-decision',
  templateUrl:'./notes-objetivos-largo-decision.component.html',
  styleUrls:['./notes-objetivos-largo-decision.component.css']
})

export class NoteObjetivosLargoDecisionComponent {
