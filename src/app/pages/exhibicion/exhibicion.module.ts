...
import { NoteExhibicionComponent } from './notes-exhibicion/notes-exhibicion.component';
...
import { EntenderExhibicionAccordionComponent } from './instructions/entender-exhibicion-accordion/entender-exhibicion-accordion.component';
...
@NgModule({
  declarations: [
    ExhibicionComponent,
    NoteExhibicionComponent,
    //TimerComponent,
    EntenderExhibicionAccordionComponent
  ],
  imports: [
    CommonModule,
