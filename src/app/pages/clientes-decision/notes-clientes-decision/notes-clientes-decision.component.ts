...
@Component({
  selector:'app-note-clientes-decision',
  templateUrl:'./notes-clientes-decision.component.html',
  styleUrls:['./notes-clientes-decision.component.css']
})

export class NoteClientesDecisionComponent {
