...
@Component({
  selector:'app-note-necesidades-decision',
  templateUrl:'./notes-necesidades-decision.component.html',
  styleUrls:['./notes-necesidades-decision.component.css']
})

export class NoteNecesidadesDecisionComponent {
