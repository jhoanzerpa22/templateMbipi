...
@Component({
  selector:'app-note-metricas-clave-decision',
  templateUrl:'./notes-metricas-clave-decision.component.html',
  styleUrls:['./notes-metricas-clave-decision.component.css']
})

export class NoteMetricasClaveDecisionComponent {
