...
@Component({
  selector:'app-note-metricas-clave',
  templateUrl:'./notes-metricas-clave.component.html',
  styleUrls:['./notes-metricas-clave.component.css']
})

export class NoteMetricasClaveComponent {
