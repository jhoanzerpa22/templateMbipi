...
@Component({
  selector:'app-note-objetivos-corto-decision',
  templateUrl:'./notes-objetivos-corto-decision.component.html',
  styleUrls:['./notes-objetivos-corto-decision.component.css']
})

export class NoteObjetivosCortoDecisionComponent {
