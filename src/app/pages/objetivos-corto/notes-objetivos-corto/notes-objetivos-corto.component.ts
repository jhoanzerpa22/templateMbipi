...
@Component({
  selector:'app-note-objetivos-corto',
  templateUrl:'./notes-objetivos-corto.component.html',
  styleUrls:['./notes-objetivos-corto.component.css']
})

export class NoteObjetivosCortoComponent {
