...
@Component({
  ...
  templateUrl: './objetivos-corto.component.html',
  styleUrls: ['./objetivos-corto.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ObjetivosCortoComponent implements OnInit, AfterViewInit, OnDestroy {
  // Public variables
  selfLayout = 'default';
  ...
  private route: ActivatedRoute
    ...
    const notes: any = localStorage.getItem('notes_objetivos_corto');
  ...
  private readBoard(tablero: any, emit: boolean){
    ...
    console.log('notas_all_objetivos_corto',data);
    this.notes_all = data;
    /*this.notes_all = [];
    for(let c in data){
  ...
  updateAllNotes() {
    console.log(document.querySelectorAll('app-note-objetivos-corto'));
    let notes = document.querySelectorAll('app-note-objetivos-corto');
  ...
  saveNoteAll() {
    ...
    const data_etapa = {etapa_activa: '/proyect-init/'+this.proyecto_id+'/fase16', tablero: this.notes_all, type: 'notas'};

    this._proyectsService.updateEtapaObjetivos(this.proyecto_id, data_etapa)
    .subscribe(
        data => {

          this.socketWebService.emitEventSetEtapa('/proyect-init/'+this.proyecto_id+'/fase16');
    ...
    //this._router.navigate(['/proyect-init/'+this.proyecto_id+'/fase16']);
  }
