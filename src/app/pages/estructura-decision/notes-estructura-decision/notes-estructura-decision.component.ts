...
@Component({
  selector:'app-note-estructura-decision',
  templateUrl:'./notes-estructura-decision.component.html',
  styleUrls:['./notes-estructura-decision.component.css']
})

export class NoteEstructuraDecisionComponent {
