...
import { NotePropuestaComponent } from './notes-propuesta/notes-propuesta.component';
...
import { EntenderPropuestaAccordionComponent } from './instructions/entender-propuesta-accordion/entender-propuesta-accordion.component';
...
@NgModule({
  declarations: [
    PropuestaComponent,
    NotePropuestaComponent,
    //TimerComponent,
    EntenderPropuestaAccordionComponent
  ],
  imports: [
    CommonModule,
