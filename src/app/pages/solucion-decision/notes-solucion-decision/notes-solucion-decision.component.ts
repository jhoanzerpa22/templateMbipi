...
@Component({
  selector:'app-note-solucion-decision',
  templateUrl:'./notes-solucion-decision.component.html',
  styleUrls:['./notes-solucion-decision.component.css']
})

export class NoteSolucionDecisionComponent {
