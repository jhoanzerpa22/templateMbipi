...
import { NoteClientesComponent } from './notes-clientes/notes-clientes.component';
...
import { EntenderClientesAccordionComponent } from './instructions/entender-clientes-accordion/entender-clientes-accordion.component';
...
@NgModule({
  declarations: [
    ClientesComponent,
    NoteClientesComponent,
    //TimerComponent,
    EntenderClientesAccordionComponent
  ],
  imports: [
    CommonModule,
