...
import { NoteAccionesComponent } from './notes-acciones/notes-acciones.component';
...
import { EntenderAccionesAccordionComponent } from './instructions/entender-acciones-accordion/entender-acciones-accordion.component';
...
@NgModule({
  declarations: [
    AccionesComponent,
    NoteAccionesComponent,
    //TimerComponent,
    EntenderAccionesAccordionComponent
  ],
  imports: [
    CommonModule,
