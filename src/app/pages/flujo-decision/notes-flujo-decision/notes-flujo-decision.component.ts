...
@Component({
  selector:'app-note-flujo-decision',
  templateUrl:'./notes-flujo-decision.component.html',
  styleUrls:['./notes-flujo-decision.component.css']
})

export class NoteFlujoDecisionComponent {
