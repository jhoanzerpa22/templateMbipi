...
import { NoteDecidirComponent } from './notes-decidir/notes-decidir.component';
...
import { EntenderDecidirAccordionComponent } from './instructions/entender-decidir-accordion/entender-decidir-accordion.component';
...
@NgModule({
  declarations: [
    DecidirComponent,
    NoteDecidirComponent,
    //TimerComponent,
    EntenderDecidirAccordionComponent
  ],
  imports: [
    CommonModule,
