...
import { NoteSolucionComponent } from './notes-solucion/notes-solucion.component';
...
import { EntenderSolucionAccordionComponent } from './instructions/entender-solucion-accordion/entender-solucion-accordion.component';
...
@NgModule({
  declarations: [
    SolucionComponent,
    NoteSolucionComponent,
    //TimerComponent,
    EntenderSolucionAccordionComponent
  ],
  imports: [
    CommonModule,
