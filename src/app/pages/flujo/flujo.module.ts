...
import { NoteFlujoComponent } from './notes-flujo/notes-flujo.component';
...
import { EntenderFlujoAccordionComponent } from './instructions/entender-flujo-accordion/entender-flujo-accordion.component';
...
@NgModule({
  declarations: [
    ...
    NoteFlujoComponent,
    //TimerComponent,
    EntenderFlujoAccordionComponent
  ],
  imports: [
    CommonModule,
