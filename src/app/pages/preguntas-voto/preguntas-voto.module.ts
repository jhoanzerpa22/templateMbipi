...
import { PreguntasVotoComponent } from './preguntas-voto.component';
...
import { PreguntasAccordionComponent } from './instructions/preguntas-accordion/preguntas-accordion.component';
...
@NgModule({
  declarations: [PreguntasVotoComponent, PreguntasAccordionComponent],
  imports: [
    CommonModule,
...
export class PreguntasVotoModule {}
