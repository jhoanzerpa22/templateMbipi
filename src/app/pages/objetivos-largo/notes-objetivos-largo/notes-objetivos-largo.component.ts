...
@Component({
  selector:'app-note-objetivos-largo',
  templateUrl:'./notes-objetivos-largo.component.html',
  styleUrls:['./notes-objetivos-largo.component.css']
})

export class NoteObjetivosLargoComponent {
