...
@Component({
  selector:'app-note-ventajas-decision',
  templateUrl:'./notes-ventajas-decision.component.html',
  styleUrls:['./notes-ventajas-decision.component.css']
})

export class NoteVentajasDecisionComponent {
