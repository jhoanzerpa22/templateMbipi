...
@Component({
  selector:'app-note-problema-decision',
  templateUrl:'./notes-problema-decision.component.html',
  styleUrls:['./notes-problema-decision.component.css']
})

export class NoteProblemaDecisionComponent {
