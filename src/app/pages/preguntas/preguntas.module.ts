...
import { NotePreguntaComponent } from './notes-preguntas/notes-preguntas.component';
...
import { EntenderPreguntasAccordionComponent } from './instructions/entender-preguntas-accordion/entender-preguntas-accordion.component';
...
@NgModule({
  declarations: [
    PreguntasComponent,
    NotePreguntaComponent,
    //TimerComponent,
    EntenderPreguntasAccordionComponent
  ],
  imports: [
    CommonModule,
