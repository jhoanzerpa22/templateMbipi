...
@Component({
  selector:'app-note-canales-decision',
  templateUrl:'./notes-canales-decision.component.html',
  styleUrls:['./notes-canales-decision.component.css']
})

export class NoteCanalesDecisionComponent {
