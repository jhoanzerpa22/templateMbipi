...
@Component({
  selector:'app-note-propositos-decision',
  templateUrl:'./notes-propositos-decision.component.html',
  styleUrls:['./notes-propositos-decision.component.css']
})

export class NotePropositosDecisionComponent {
