...
@Component({
  selector:'app-note-metricas-decision',
  templateUrl:'./notes-metricas-decision.component.html',
  styleUrls:['./notes-metricas-decision.component.css']
})

export class NoteMetricasDecisionComponent {
