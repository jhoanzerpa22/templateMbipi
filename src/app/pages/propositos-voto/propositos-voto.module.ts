...
import { PropositosVotoComponent } from './propositos-voto.component';
...
import { PropositosAccordionComponent } from './instructions/propositos-accordion/propositos-accordion.component';
...
@NgModule({
  declarations: [PropositosVotoComponent, PropositosAccordionComponent],
  imports: [
    CommonModule,
...
export class PropositosVotoModule {}
