...
@Component({
  selector: 'app-propositos-voto',
  templateUrl: './propositos-voto.component.html',
  styleUrls: ['./propositos-voto.component.scss'],
  encapsulation  : ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PropositosVotoComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    this.socketWebService.outEvenTableroVotoPropositos.subscribe((res: any) => {
    ...
    this._proyectsService.get(this.proyecto_id)
      .subscribe(
          (response) => {
            ...
            console.log('propositos',propositos);

              this.tablero.push({'title': 'Propositos', "data": propositos});
  ...
  saveVotoAll(){
    ...
    console.log('save_voto_all_propositos',this.tablero);
    let tablero: any = [];
    ...
    for(let n in this.tablero){
      ...
      for(let m in this.tablero[n].data){
        ...
        tablero.push({'title': this.tablero[n].title, "data": propositos});
    }
    ...
    const data_etapa = {etapa_activa: '/proyect-init/'+this.proyecto_id+'/fase15', tablero: tablero, type: 'voto'};
    ...
    .subscribe(
        data => {
          ...
          this.socketWebService.emitEventTableroSaveVotoPropositos({tablero: JSON.stringify(tablero)});
  ...
  private writeBoard(){
    ...
    this.socketWebService.emitEventTableroVotoPropositos({tablero: JSON.stringify(this.tablero)});
  }
