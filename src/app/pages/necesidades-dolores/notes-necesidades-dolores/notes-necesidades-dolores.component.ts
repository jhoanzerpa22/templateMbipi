...
@Component({
  selector:'app-note-necesidades-dolores',
  templateUrl:'./notes-necesidades-dolores.component.html',
  styleUrls:['./notes-necesidades-dolores.component.css']
})

export class NoteNecesidadesDoloresComponent {
