...
import { NoteEstructuraComponent } from './notes-estructura/notes-estructura.component';
...
import { EntenderEstructuraAccordionComponent } from './instructions/entender-estructura-accordion/entender-estructura-accordion.component';
...
@NgModule({
  declarations: [
    EstructuraComponent,
    NoteEstructuraComponent,
    //TimerComponent,
    EntenderEstructuraAccordionComponent
  ],
  imports: [
    CommonModule,
