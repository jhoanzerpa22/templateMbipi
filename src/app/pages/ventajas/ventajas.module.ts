...
import { NoteVentajasComponent } from './notes-ventajas/notes-ventajas.component';
...
import { EntenderVentajasAccordionComponent } from './instructions/entender-ventajas-accordion/entender-ventajas-accordion.component';
...
@NgModule({
  declarations: [
    VentajasComponent,
    NoteVentajasComponent,
    //TimerComponent,
    EntenderVentajasAccordionComponent
  ],
  imports: [
    CommonModule,
